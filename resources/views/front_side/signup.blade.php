              ...
              <form method="POST" action="{{ route('register') }}">
                @csrf
                  <div class="form-row">
                    <div class="col-md-12">
                      <div class="input-group mb-3">
                        ...
                        <input type="text" name="name" class="form-control cst" placeholder="Full Name">
                      </div>
                    </div>
                  </div>
                  <div class="form-row">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="file" class="form-control cst">
                  </div>
                  <div>
                    <div class="form-check mt-3">
                      <input class="form-check-input" type="radio" value="0" name="role" id="patient">
                      <label class="form-check-label" for="patient">
                        Patient
                      </label>
                    </div>
                    <div class="form-check mt-1 mb-3">
                      <input class="form-check-input" type="radio" input="1" name="role" id="donor" checked>
