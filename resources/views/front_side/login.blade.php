    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-12">
          <img class="front_assets/login-img" src="front_assets/images/login.png" alt="">
        </div>
        <div class="col-md-6 col-sm-12 login-cl">
                  ...
                  <div class="form-row">
                    <div class="col-md-12">
                      <div class="input-group mb-3">
                        ...
                        <input type="email" class="form-control cst" placeholder="Email">
                      </div>
                    </div>
                  </div>
                  <div class="input-group mb-3">
