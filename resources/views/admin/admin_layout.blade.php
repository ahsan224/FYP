            ...
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{url('patient-appointments')}}">
                            <i class="align-middle" data-feather="users"></i> <span class="align-middle">Appointments</span>
                         </a>
                    </li>

                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{url('adminview_medicines')}}">
                            <i class="align-middle" data-feather="users"></i> <span class="align-middle">Medicines</span>
                         </a>
                    </li>
